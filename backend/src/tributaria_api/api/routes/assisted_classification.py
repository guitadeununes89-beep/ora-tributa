...
def review_classification(
    ...
    required = ("product_id", "product_version_id", "catalog_version_id", "ruleset_id")
    if any(not evaluation.get(field) for field in required):
    ...
    review = products.record_tax_review(
        ...
        ruleset_id=str(evaluation["ruleset_id"]),
